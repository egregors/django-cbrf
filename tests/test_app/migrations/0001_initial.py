    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso_num_code',
                 models.SmallIntegerField(blank=True, default=None, null=True, verbose_name='ISO numeric code')),
                ('iso_char_code', models.CharField(blank=True, db_index=True, default=None, max_length=3, null=True,
                                                   verbose_name='ISO char code')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_field', models.CharField(max_length=8)),
                ('currency',
                 models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test_app_record',
                                   to='test_app.Currency')),
            ],
            options={
                'verbose_name': 'record',
